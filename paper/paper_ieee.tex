...
%
% [ESTADO 2026-05-05] Versión congelada de un draft anterior. La
% versión canónica vigente es `paper_ieee_en.tex` (en inglés),
% completamente reescrita con triple contribución, baselines B1/B2/B3,
% R1-R4 robustness, etc. Cualquier corrida nueva (multiseed, R5/R6,
% v3/v4, H_TC) se refleja primero en la versión inglesa. Esta versión
% española se reserva para los venues regionales (Khipu, LatinX in AI)
% y se sincronizará selectivamente cuando se decida el venue.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\texttt{20260419\_222128\_9d4e55}. Suite de tests: 305 \emph{tests}
